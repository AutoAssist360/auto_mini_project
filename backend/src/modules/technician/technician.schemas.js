...
export const techSendOtpSchema = z.object({
  email: z.string().regex(emailRegex, "Invalid email format"),
});

export const techSignupWithOtpSchema = techSignupSchema.extend({
...
export const techForgotPasswordSchema = z.object({
  email: z.string().regex(emailRegex, "Invalid email format"),
});

export const techResetPasswordSchema = z.object({
  token: z.string().min(1, "Reset token is required"),
  new_password: z.string().min(8, "Password must be at least 8 characters"),
});

export const techChangePasswordSchema = z.object({
...
export const updateProfileSchema = z
  .object({
    ...
    bank_holder_name: z.string().max(200).nullable().optional(),
  })
...
export const addCarSupportSchema = z.object({
...
export const addPartSkillSchema = z.object({
