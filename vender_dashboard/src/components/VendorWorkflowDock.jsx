...
const WORKFLOW_ITEMS = [
  {
    label: 'Dashboard',
    shortLabel: 'Home',
    hint: 'See your business overview and next actions.',
    to: '/dashboard',
  ...
  },
  {
    label: 'Profile',
    shortLabel: 'Profile',
    hint: 'Keep business and payment details up to date.',
    to: '/profile',
    matches: (pathname) => pathname === '/profile' || pathname === '/change-password',
  },
  {
    label: 'Locations',
    shortLabel: 'Locations',
    hint: 'Manage your store locations, stock, held items, and bulk updates.',
    to: '/warehouses',
    matches: (pathname) => (
      pathname === '/warehouses' ||
      /^\/warehouses\/[^/]+\/inventory$/.test(pathname) ||
      /^\/warehouses\/[^/]+\/reservations$/.test(pathname) ||
      /^\/warehouses\/[^/]+\/bulk-import$/.test(pathname) ||
  ...
  },
  {
    label: 'Orders',
    shortLabel: 'Orders',
    hint: 'Confirm, fulfil, and track customer orders.',
    to: '/orders',
    matches: (pathname) => pathname === '/orders' || /^\/orders\/[^/]+$/.test(pathname),
  },
  {
    label: 'Analytics',
    shortLabel: 'Overview',
    hint: 'Review sales, stock movement, and business performance.',
    to: '/analytics',
  ...
  },
  {
    label: 'Ledger',
    shortLabel: 'Payments',
    hint: 'Check earnings, dues, and payment history.',
    to: '/ledger',
        ...
        <div className="flex items-center gap-3">
          <div className="min-w-0 flex-1 rounded-2xl border border-blue-500/10 bg-blue-50/80 px-4 py-3 dark:border-blue-500/20 dark:bg-blue-500/10">
            ...
            <p className="truncate text-xs text-slate-500 dark:text-slate-400">
              {currentItem?.hint || 'Jump to the next task without going back first.'}
            </p>
          </div>
          ...
          <button
            ...
            aria-label={isExpanded ? 'Close vendor guide' : 'Open vendor guide'}
...
export default VendorWorkflowDock
