      ...
      <div className="mx-auto max-w-4xl">
        <header className="mb-8">
          ...
          <p className="mt-2 text-slate-500 dark:text-slate-400">
            See what customers are saying about your fulfilled orders.
          </p>
        </header>
          ...
          {loading ? (
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-12 text-center shadow-sm dark:border-slate-800/50 dark:bg-slate-900/50">
              <p className="text-sm font-bold text-slate-500 dark:text-slate-400">
                You don't have any reviews yet. Fulfill more parts to gather feedback.
              </p>
            </div>
          ) : (
            <div className="space-y-4">
