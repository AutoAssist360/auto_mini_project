  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-slate-50 font-['Outfit',_sans-serif] text-slate-900 transition-colors duration-500 selection:bg-blue-500/30 dark:bg-[#030712] dark:text-slate-100">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <header className="mb-6 rounded-[32px] border border-slate-200 bg-white/80 px-4 py-4 shadow-xl backdrop-blur-md transition-all dark:border-slate-800 dark:bg-[#0B1120]/85 dark:shadow-2xl sm:px-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                <span className="text-[11px] font-black uppercase tracking-[0.25em] text-blue-600 dark:text-blue-400">
                  Quick Auto Assist
                </span>
            ...
            <div className="flex items-center justify-between gap-3 lg:justify-end">
              <Link
                to="/profile"
                className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-slate-200 bg-slate-100 text-sm font-bold text-slate-700 transition-colors hover:border-blue-500 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"
              ...
              <MobileNav>
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-slate-100 transition-all hover:bg-slate-200 dark:border-slate-700 dark:bg-slate-800 dark:hover:bg-slate-700"
                ...
                <button
                  ...
                  className="whitespace-nowrap rounded-full bg-blue-600 px-5 py-2.5 text-[10px] font-black uppercase tracking-[0.2em] text-white shadow-lg shadow-blue-600/20 transition-all hover:bg-blue-500 active:scale-95"
                >
                  Logout
                </button>
              </MobileNav>
        ...
        {showWelcome && (
          <section className="relative mb-8 overflow-hidden rounded-[32px] border border-slate-200 bg-white p-6 shadow-xl transition-all duration-700 dark:border-slate-800/50 dark:bg-gradient-to-br dark:from-[#0B1120] dark:to-[#040814] dark:shadow-2xl sm:p-8 md:p-10">
            ...
            <div className="relative z-10">
              <div className="mb-6 flex items-start justify-between gap-4">
                <div className="inline-flex items-center gap-2 rounded-full border border-blue-500/20 bg-blue-500/10 px-4 py-1.5 text-[10px] font-black uppercase tracking-[0.25em] text-blue-600 dark:text-blue-400">
                  <div className="h-1.5 w-1.5 rounded-full bg-blue-500" />
                  Welcome
                </div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <div className="flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 dark:border-slate-800 dark:bg-slate-900/50">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-700 dark:text-slate-300">
                    System online
                  </span>
                </div>
                <div className="flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 dark:border-slate-800 dark:bg-slate-900/50">
              ...
              <div className="relative z-10 flex h-full flex-col">
                <div className="mb-6 flex items-start justify-between gap-4">
                  <div>
                    ...
                    <h3 className="mt-2 text-xl font-black tracking-tight text-slate-900 transition-colors group-hover:text-blue-600 dark:text-white dark:group-hover:text-blue-400">
                      {card.title}
                    </h3>
                  </div>
                ...
                <button
                  ...
                  className={`relative w-full overflow-hidden rounded-2xl py-3.5 text-[10px] font-black uppercase tracking-[0.25em] transition-all active:scale-[0.98] ${
                    card.primary
